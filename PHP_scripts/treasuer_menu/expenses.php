...
<head> 
	...
	<!-- Our CSS -->
	<link rel="stylesheet" type="text/css" href="style_table.css" title="Arkusz stylów CSS">
...
<div class="container-fluid">
	<div class="row">
		<div class="ml-3" id ="class_account_information"></div>
	</div>
	<div class="row text-center">
		<h5 class="col-md-12"> Lista wydatków </h5>
	</div>
 </div>
 

<div id="expenses_list" class="container-fluid"></div>
...
$(document).ready(function(){
    function fetch_class_account_information()
    {
        $.ajax({
            ...
            method:"POST",
            data:{function2call:'fetch_class_account_information'},
            success:function(data){
                $('#class_account_information').html(data);
            }
        });
